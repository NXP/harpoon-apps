...
do_clean
echo "build "$1""
cmake -DCMAKE_TOOLCHAIN_FILE="../../../../../../mcux-sdk/tools/cmake_toolchain_files/armgcc_aarch64.cmake" -G "Unix Makefiles" -DCMAKE_BUILD_TYPE=ddr_release ${CODEC_DEVICE_TYPE} -DDEMO_TYPE="$1" .
make -j $(nproc)
}
